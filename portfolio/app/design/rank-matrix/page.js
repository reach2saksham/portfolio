...
const caseStudy = {
  ...
  coverVideo: {
    ...
    posterFrame: "/design/rank-matrix/coverimage.avif", // Add a poster frame image
  },
};
        ...
        <div className="flex flex-wrap lg:flex-nowrap flex-col lg:flex-row-reverse">
          <div className="w-full h-[32vh] sm:h-auto lg:w-3/4 pb-4 lg:pb-0 relative">
            ...
            <video
              ...
              className={`w-full h-full object-cover sm:object-none sm:h-auto transition-opacity duration-300 ${
          ...
          <div className="flex flex-col w-full lg:w-3/4 pt-2 lg:pt-0">
            ...
            <div className="flex gap-4 flex-col lg:flex-row">
              ...
              <ExpandImage
                ...
                height={460}
                title="Iteration 4"
                subtitle="Too much wisdom in one frame"
                alt="Another Banner"
              />
            </div>
            <div className="flex gap-4 flex-col lg:flex-row">
              ...
              <ExpandImage
                ...
                height={460}
                title="Finalised"
                subtitle="But it was policy to not advertise our college through this"
                alt="Small Banner"
              />
            </div>
