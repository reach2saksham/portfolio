...
const caseStudy = {
  ...
  deliverables: [
    ...
    "Case study page tempelate",
    "Employee life cycle UX research",
  ],
  ...
  coverVideo: {
    ...
    posterFrame: "/design/uix-labs/coverimage.avif", // Add a poster frame image
  },
};
      ...
      <div className="projects container max-w-full pt-4 sm:mt-0 mx-auto px-4 xl:px-20 lg:px-14 sm:px-4">
        ...
        <div className="flex flex-col lg:flex-row pt-6 min-h-screen">
          ...
          <div className="flex flex-col w-full lg:w-3/4 pt-2 lg:pt-0">
            ...
            <ExpandImage
              className="w-full h-fobject-cover pt-4 pb-4"
