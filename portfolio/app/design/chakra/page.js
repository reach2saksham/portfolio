...
const caseStudy = {
    ...
    deliverables: ['Landing, Search & Faculty Pages Revamp', 'Design System', 'Content Management System'],
                ...
                <div className="flex flex-col lg:flex-row pt-6 min-h-screen">
                    ...
                    <aside className="w-full lg:w-1/4 lg:sticky lg:top-[70px] lg:self-start lg:max-h-[calc(100vh-70px)] lg:overflow-y-auto">
                        <div className="flex flex-col w-full hidden lg:block">
                            ...
                            {caseStudy.domain && (
                                <div className="sfpro text-sm pt-2 text-[#646464] tracking-wider">{caseStudy.domain}</div>
                            )}
                    ...
                    <div className="flex flex-col w-full lg:w-3/4 lg:pt-0">
                        ...
                        <div
                            id='landing'
                            className='pt-12 text-3xl company'>LANDING PAGE</div>
                        ...
                        <div className='pt-4 flex flex-col gap-8'>
                            ...
                            <div>
                                {activeMode === 'mobile' && (
                                    <div>
                                        <ExpandImage className='w-full h-full object-cover sm:px-56 md:px-64 lg:px-72 xl:px-80'
                                ...
                                {activeMode === 'purple' && (
                                    <div>
                                        <ExpandImage className='w-full h-full object-cover px-[0.6px]'
                                        ...
                                        />
                                        <ExpandImage className='w-full h-full object-cover px-[0.6px] -mt-1'
                        ...
                        <div
                            id='search'
                            className='pt-8 text-3xl company'>SEARCH PAGE</div>
                        ...
                        <div
                            id='faculty'
                            className='pt-12 text-3xl company'>FACULTY PAGE</div>
                        ...
                        <div
                            id='chakra'
                            className='pt-12 text-3xl company'>CHAKRA</div>
                            ...
                            <li>Only individuals with development knowledge can create or edit webpages.</li>
                            <li>Every minor change requires re-deployment.</li>
                            <li>Design consistency is hard to maintain across different pages.</li>
                            <li>It creates a dependency bottleneck between non-technical users and developers.</li>
                            </div>
                            ...
                            <ol type='1' className='flex flex-col gap-2 pt-2'>
                                <li>1. Component Selection: Users choose from a library of ready-to-use components.</li>
                                <li>2. Content Input: They fill in the data.</li>
                                <li>3. Transpilation Process: Chakra generates an XML, which is then transpiled into HTML using our custom-built transpiler in Scala.</li>
                                <li>4. Automatic Deployment: The system manages file storage and deploys pages automatically.</li>
                            </ol>
                            ...
                            <div className='pt-4 font-bold text-xl'>{`Chakra's Four Pillars:`}</div>
                            <div className='pt-2'>{`The platform is built on four main pillars. Chakra Frontend offers a user-friendly interface for intuitive webpage creation. Chakra Backend acts as the system’s core, integrating all functionalities with the database. Chakra UI Library maintains a curated collection of reusable, pre-designed components that uphold consistency and quality. Finally, Chakra Canvas serves as a staging environment where all changes can be tested and fine-tuned before being made live to the public.`}</div>
                        <ExpandImage className='w-full h-full object-cover pt-4'
