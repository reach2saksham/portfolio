...
const caseStudy = {
    ...
    // },
    thewhat: `A Product Design for CMS | A Design System / UI Kit for College's Websites | Revamped Loading Screens, Animations, Landing Page with added features`,
        ...
        <main
           ...
           <div
            ...
            <ExpandImage className='w-full h-full object-cover pt-4'
                src='/design/chakra/highlight.png'
                width={1660}
                height={800}
                alt='Small Banner'
                priority
            ...
            <div
              ...
              <ExpandImage className='w-full h-full object-cover pt-4'
                src='/design/chakra/font-color.png'
                width={1660}
                height={800}
                alt='Small Banner'
                priority
              ...
              <div className=''>
                <div className="flex gap-4 flex-col lg:flex-row">
                  ...
                  <BlurImage src="/design/chakra/iteration2.png" width={460} height={460} title="Iteration 1" subtitle="Pretty" alt="Another Banner" />
                  <BlurImage src="/design/chakra/iteration1.png" width={460} height={460} title="Iteration 2" subtitle="A little chaotic" alt="Another Banner" />

                </div>
              </div>
              <div className="flex gap-4 flex-col lg:flex-row">
                <BlurImage src="/design/chakra/iteration5.png" width={460} height={460} title="Iteration 3" subtitle="Too Utilitarian" alt="Small Banner" />
                <BlurImage src="/design/chakra/iteration4.png" width={460} height={460} title="Iteration 4" subtitle="Too much wisdom in one frame" alt="Another Banner" />
              </div>
              <div className="flex gap-4 flex-col lg:flex-row">
                <BlurImage src="/design/chakra/iteration3.png" width={460} height={460} title="Iteration 5" subtitle="That James Thomson Builduibng svg took time" alt="Small Banner" />
              ...
              <video
                src="/design/chakra/loaderfigma.mp4"
                autoPlay
                loop
                muted
                playsInline
              ...
              <ExpandImage className='w-full h-full object-cover pt-4'
                src='/design/chakra/problems.png'
                width={1660}
                height={800}
                alt='Small Banner'
                priority
