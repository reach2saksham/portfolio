...
const designitems = {
  ...
  card2: {
    ...
    height: 380,
    alt: 'Mockup',
    tags: ['College Project', 'January 2024 - May 2024'],
    role: ['Project Leader',],
  ...
  card3: {
    ...
    height: 380,
    alt: 'Mockup',
    tags: ['Internship', 'March 2025 - April 2025'],
  ...
  card4: {
    ...
    height: 380,
    alt: 'Mockup',
    tags: ['Student Society', 'April 2023 - May 2023'],
...
const businessitems = {
  ...
  card4: {
    ...
    height: 380,
    alt: 'Mockup',
    tags: ['Startup Analysis', `August 2023`],
...
const Projects = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-30 flex items-center sm:flex-row justify-center gap-2 sm:gap-4 py-4 font-ssromandisplay text-3xl sm:text-6xl font-medium select-none">
