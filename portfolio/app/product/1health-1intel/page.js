...
const caseStudy = {
    industry: 'Healthcare and Pharmaceuticals Industry',
    techStack: {
        'Design Tools': ['figma'],
    },
    ...
    companyName: '1HEALTH-1INTEL',
    period: 'December 2024 - February 2025',
    domain: 'HEALTHCARE ACCESSIBILITY',
    description: `This case study explores comprehensive healthcare apps, “1Health” and a “1Intel” health data management platforms aimed at addressing gaps in healthcare accessibility, efficiency, and data handling. By using AI, IoT, and advanced data harmonization, these platforms seeks to streamline patient-doctor interactions, enhance EHR usability, and improve compliance with healthcare regulations. Key features include predictive analytics, automated data processing, and user-friendly interfaces for diverse personas.`,
