                ...
                <div className="flex flex-col lg:flex-row pt-6 min-h-screen">
                    ...
                    <div className="flex flex-col w-full lg:w-3/4 pt-2 lg:pt-0">
                        ...
                        <div className='flex flex-col lg:flex-row gap-1 justify-center items-center pt-4'>
                            <div>
                                <ExpandImage className='w-full h-full object-cover'
                                    src='/business/c-suite/certificate.avif'
                                    width={520}
                                    height={800}
                                    alt='Small Banner'
                                    priority
                            ...
                            <div>
                                <ExpandImage className='w-full h-full object-cover'
                                    src='/business/c-suite/igpost.avif'
                                    width={398}
                                    height={800}
                                    alt='Small Banner'
                                    priority
                        ...
                        <div
                            ...
                            id='tldr'
                            className='pt-12 flex flex-col'>
                            <div className='text-3xl font-offbit'>TL;DR Problem Statement</div>
                            ...
                            <div
                                id='swot'
                                className='pt-12 text-3xl font-offbit'>SWOT ANALYSIS</div>

                            <ExpandImage className='w-full h-full object-cover pt-2'
                                src='/business/c-suite/2.avif'
                                width={1660}
                                height={800}
                                alt='Small Banner'
                                priority
                            ...
                            <div
                                id='strategies'
                                className='pt-12 text-3xl font-offbit'>STRATEGIES AND IMPACT</div>
                            <ExpandImage className='w-full h-full object-cover pt-2'
                                src='/business/c-suite/3.avif'
                                width={1660}
                                height={800}
                                alt='Small Banner'
                                priority
