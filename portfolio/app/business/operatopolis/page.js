                ...
                <div className="flex flex-col lg:flex-row pt-6 min-h-screen">
                    ...
                    <div className="flex flex-col w-full lg:w-3/4 pt-2 lg:pt-0">
                        ...
                        <div
                            ...
                            <div
                                id='breakdown'
                                className='pt-12 text-3xl font-offbit'>PROBLEM BREAKDOWN</div>
                            ...
                            <div
                                id='initial'
                                className='pt-12 text-3xl font-offbit'>INITIAL CONDITIONS</div>
                            ...
                            <div
                                id='tmm'
                                className='pt-12 text-3xl font-offbit'>TRAPEZOIDAL MATRIX METHOD</div>
